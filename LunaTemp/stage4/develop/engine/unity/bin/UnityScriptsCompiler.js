...
if ( TRACE ) { TRACE( "PlayableManager#init", this ); }
                ...
                this.installButtonColor = new UnityEngine.Color();
                this.installColor = new UnityEngine.Color();
                this.cubeList = new (System.Collections.Generic.List$1(UnityEngine.GameObject)).ctor();
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "PlayableManager#Start", this ); }
                ...
                if (UnityEngine.Object.op_Implicit(this.installButton)) {
                    this.installButton.image.color = this.installButtonColor.$clone();
                    this.installButtonText.text = this.installText;
                    this.installButtonText.color = this.installColor.$clone();
                }
